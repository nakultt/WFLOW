...
import { Home, Settings, Bell, Grid, Workflow, LayoutDashboard } from "lucide-react";
import { useNavigate } from "react-router-dom";
const wflowLogo = "/locus_logo.png";
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                   <img src={wflowLogo} alt="WFLOW Logo" className="w-10 h-10 object-contain" />
                  <div>
                    <p className="font-semibold">WFLOW</p>
